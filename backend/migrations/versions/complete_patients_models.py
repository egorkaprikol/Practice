"""complete patients models

Revision ID: fda1dc4d2518
Revises: bd1c7a34461f
Create Date: 2024-08-03 15:53:19.178587
...
revision: str = "fda1dc4d2518"
down_revision: Union[str, None] = "bd1c7a34461f"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_patients_number"), "patients", ["number"], unique=True
    )
    op.create_table(
        "appointments",
        sa.Column("id", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_patients_number"), table_name="patients")
